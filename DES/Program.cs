...
namespace DES
{
    class Program
    {
        ...
        static void ReadFile(string Location, List<int> a)
        {
            string[] read;
        ...
        static void Main(string[] args)
        {
            ...
            ReadFile("../../data/program/E.txt", E);
            ReadFile("../../data/program/IP.txt", IP);
            ReadFile("../../data/program/S1.txt", S1);
            ReadFile("../../data/program/S2.txt", S2);
            ReadFile("../../data/program/S3.txt", S3);
            ReadFile("../../data/program/S4.txt", S4);
            ReadFile("../../data/program/S5.txt", S5);
            ReadFile("../../data/program/S6.txt", S6);
            ReadFile("../../data/program/S7.txt", S7);
            ReadFile("../../data/program/S8.txt", S8);
            ReadFile("../../data/program/P.txt", P);
            ReadFile("../../data/program/IP2.txt", IP2);
            ReadFile("../../data/program/PC1.txt", PC1);
            ReadFile("../../data/program/LeftShifts.txt", leftShift);
            ReadFile("../../data/program/PC2.txt", PC2);
            ReadFile("../../data/user/Input.txt", Input);
            ReadFile("../../data/user/Key.txt", Key);
            ReadFile("../../data/user/Key.txt", KeyBD);
